...
#define INHNO_DMARTX  IRQ_VECTOR_DMA12_CH_LOW	/* 割込みハンドラ番号 */
#define INTNO_DMARTX  IRQ_VECTOR_DMA12_CH_LOW	/* 割込み番号 */
...
#define INHNO_ADC     IRQ_VECTOR_ADC1	/* 割込みハンドラ番号 */
#define INTNO_ADC     IRQ_VECTOR_ADC1	/* 割込み番号 */
