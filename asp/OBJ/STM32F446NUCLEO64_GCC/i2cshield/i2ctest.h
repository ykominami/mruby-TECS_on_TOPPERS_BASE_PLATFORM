...
#define INHNO_I2CEV   IRQ_VECTOR_I2C2_EV	/* 割込みハンドラ番号 */
#define INTNO_I2CEV   IRQ_VECTOR_I2C2_EV	/* 割込み番号 */
#define INTPRI_I2CEV  -5			/* 割込み優先度 */
#define INTATR_I2CEV  0				/* 割込み属性 */

#define INHNO_I2CER   IRQ_VECTOR_I2C2_ER	/* 割込みハンドラ番号 */
#define INTNO_I2CER   IRQ_VECTOR_I2C2_ER	/* 割込み番号 */
#define INTPRI_I2CER  -5			/* 割込み優先度 */
#define INTATR_I2CER  0				/* 割込み属性 */
#endif
