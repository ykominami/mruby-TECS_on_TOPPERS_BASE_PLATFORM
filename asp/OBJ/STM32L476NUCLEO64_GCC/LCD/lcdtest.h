...
#define INHNO_DMARX  IRQ_VECTOR_DMA2_CH3	/* 割込みハンドラ番号 */
#define INTNO_DMARX  IRQ_VECTOR_DMA2_CH3	/* 割込み番号 */
#define INTPRI_DMARX -5          /* 割込み優先度 */
#define INTATR_DMARX TA_EDGE     /* 割込み属性 */

#define INHNO_DMATX  IRQ_VECTOR_DMA2_CH4	/* 割込みハンドラ番号 */
#define INTNO_DMATX  IRQ_VECTOR_DMA2_CH4	/* 割込み番号 */
#define INTPRI_DMATX -5          /* 割込み優先度 */
...
#define INHNO_ADC     IRQ_VECTOR_ADC1_2	/* 割込みハンドラ番号 */
#define INTNO_ADC     IRQ_VECTOR_ADC1_2	/* 割込み番号 */
