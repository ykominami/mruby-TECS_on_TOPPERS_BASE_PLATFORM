...
void main_task(intptr_t exinf)
{
    ...
    i2c_initd.Timing          = 0x40912732;
//    i2c_initd.Timing          = 0x00D00E28;	/* ROI DEBUG */
	...
	while(count < 1000){
		if((ercd = i2c_memread(hi2c, (uint16_t)ADT7410_ADDR, ADT7410_TEMP_H, I2C_MEMADD_SIZE_8BIT, (uint8_t*)aRxBuffer, 1, 500)) != E_OK){
			/* I2C RECEIVE ERROR */
			syslog_2(LOG_ERROR, "## I2C ERROR(14)(%d)[%08x] ##", ercd, hi2c->ErrorCode);
			goto stop_task;
		}
		temp = aRxBuffer[0] << 8;
