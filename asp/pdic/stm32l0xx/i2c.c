 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: i2c.c 698 2017-07-19 21:36:31Z roi $
 */
/*
 *
 *  I2Cドライバ関数群(STM32L0XX)
 *
 */
...
static const I2C_PortControlBlock i2c_pcb[NUM_I2CPORT] = {
  ...
  {	TADR_I2C2_BASE,
	...
	TADR_GPIOB_BASE, TADR_GPIOB_BASE,
	10, GPIO_AF6_I2C2, 11, GPIO_AF6_I2C2 },

  {	TADR_I2C3_BASE,
	(TADR_RCC_BASE+TOFF_RCC_IOPENR),   RCC_IOPENR_GPIOAEN, RCC_IOPENR_GPIOBEN,
	(TADR_RCC_BASE+TOFF_RCC_APB1ENR),  RCC_APB1ENR_I2C3EN,
	(TADR_RCC_BASE+TOFF_RCC_APB1RSTR), RCC_APB1RSTR_I2C3RST,
	TADR_GPIOA_BASE, TADR_GPIOB_BASE,
	8, GPIO_AF7_I2C3, 4, GPIO_AF7_I2C3 }
};
