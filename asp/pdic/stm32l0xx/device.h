 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: device.h 698 2017-11-03 12:51:22Z roi $
 */
/*
 * STM32L0XX用デバイスドライバの外部宣言
 */
...
#define NUM_EXTI0_FUNC   2
#define EXTI0_BASENO     0
#define NUM_EXTI2_FUNC   2
#define EXTI2_BASENO     2
#define NUM_EXTI4_FUNC   12
#define EXTI4_BASENO     4

#define INTPRI_SW1      -1			/* 割込み優先度 */
#define INTATR_SW1       0			/* 割込み属性 */

#if defined(TOPPERS_STM32LORA_DISCOVERY)
#define INHNO_SW1  IRQ_VECTOR_EXTI2_3	/* 割込みハンドラ番号 */
#define INTNO_SW1  IRQ_VECTOR_EXTI2_3	/* 割込み番号 */
#define EXTI_BASENO      EXTI2_BASENO
#define sw_handler       exti2_handler
#define exti_func        exti2_func
#else
#define INHNO_SW1  IRQ_VECTOR_EXTI4_15	/* 割込みハンドラ番号 */
#define INTNO_SW1  IRQ_VECTOR_EXTI4_15	/* 割込み番号 */
#define EXTI_BASENO      EXTI4_BASENO
#define sw_handler       exti4_handler
#define exti_func        exti4_func
#endif

extern void (*exti0_func[NUM_EXTI0_FUNC])(void);
extern void (*exti2_func[NUM_EXTI2_FUNC])(void);
extern void (*exti4_func[NUM_EXTI4_FUNC])(void);
