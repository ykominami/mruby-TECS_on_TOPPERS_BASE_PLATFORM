...
static const SPI_PortControlBlock spi_pcb[NUM_SPIPORT] = {
  {	TADR_SPI1_BASE,
	(TADR_RCC_BASE+TOFF_RCC_IOPENR), RCC_IOPENR_GPIOAEN, RCC_IOPENR_GPIOAEN,
	...
	5, 6, 7, GPIO_AF0_SPI1,
	TADR_DMA1_CH3_BASE, DMA_REQUEST_1,
	TADR_DMA1_CH2_BASE, DMA_REQUEST_1 },

  {	TADR_SPI2_BASE,
	(TADR_RCC_BASE+TOFF_RCC_IOPENR), RCC_IOPENR_GPIOBEN, RCC_IOPENR_GPIOBEN,
	(TADR_RCC_BASE+TOFF_RCC_APB1ENR), RCC_APB1ENR_SPI2EN,
	(TADR_RCC_BASE+TOFF_RCC_AHBENR), RCC_AHBENR_DMA1EN,
	TADR_GPIOB_BASE, TADR_GPIOB_BASE, TADR_GPIOB_BASE,
	13, 14, 15, GPIO_AF0_SPI2,
	TADR_DMA1_CH5_BASE, DMA_REQUEST_2,
	TADR_DMA1_CH4_BASE, DMA_REQUEST_2 },
};
...
spi_init(ID port, SPI_Init_t *spii)
{
	...
	if(spii->DataSize == SPI_DATASIZE_16BIT){
	 ...
	 *  SPI CR1/CR2レジスタ設定
	 */
	sil_wrw_mem((uint32_t *)(hspi->base+TOFF_SPI_CR1), (hspi->Init.Mode | hspi->Init.Direction | hspi->Init.DataSize |
...
#ifndef TOPPERS_STM32L073_NUCLEO64
	/*
	 *  SPI I2CSモードをリセット
	 */
