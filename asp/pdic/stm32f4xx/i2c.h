 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: i2c.h 698 2016-02-09 14:12:10Z roi $
 */
/*
 * 
 *  STM32F4xx I2Cデバイスドライバの外部宣言
 *
 */
...
#define I2C_ADDRESSINGMODE_10BIT (I2C_OAR1_ADDMODE | I2C_OAR1_OA1EN)
...
typedef struct
{
	uint32_t              ClockSpeed;		/* I2C クロックスピード */
	uint32_t              DutyCycle;		/* I2C デューティサイクル */
