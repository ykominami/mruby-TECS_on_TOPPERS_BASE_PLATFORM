 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: spi.c 698 2016-07-31 13:20:10Z roi $
 */
/*
 * 
 *  SPIドライバ関数群
...
static const SPI_PortControlBlock spi_pcb[NUM_SPIPORT] = {
  {	TADR_SPI1_BASE,
	(TADR_RCC_BASE+TOFF_RCC_AHB2ENR), RCC_AHB2ENR_GPIOAEN, RCC_AHB2ENR_GPIOAEN,
	...
	5, 6, 7, GPIO_AF5_SPI1,
	TADR_DMA2_CH4_BASE, DMA_REQUEST_4,
	TADR_DMA2_CH3_BASE, DMA_REQUEST_4 },

  {	TADR_SPI2_BASE,
	(TADR_RCC_BASE+TOFF_RCC_AHB2ENR), RCC_AHB2ENR_GPIOBEN, RCC_AHB2ENR_GPIOBEN,
	(TADR_RCC_BASE+TOFF_RCC_APB1ENR1), RCC_APB1ENR1_SPI2EN,
	(TADR_RCC_BASE+TOFF_RCC_AHB1ENR), RCC_AHB1ENR_DMA1EN,
	TADR_GPIOB_BASE, TADR_GPIOB_BASE, TADR_GPIOB_BASE,
	13, 14, 15, GPIO_AF5_SPI2,
	TADR_DMA1_CH5_BASE, DMA_REQUEST_1,
	TADR_DMA1_CH4_BASE, DMA_REQUEST_1 },

  {	TADR_SPI3_BASE,
	(TADR_RCC_BASE+TOFF_RCC_AHB2ENR), RCC_AHB2ENR_GPIOCEN, RCC_AHB2ENR_GPIOCEN,
	(TADR_RCC_BASE+TOFF_RCC_APB1ENR1), RCC_APB1ENR1_SPI3EN,
	(TADR_RCC_BASE+TOFF_RCC_AHB1ENR), RCC_AHB1ENR_DMA2EN,
	TADR_GPIOC_BASE, TADR_GPIOC_BASE, TADR_GPIOC_BASE,
	10, 11, 12, GPIO_AF5_SPI3,
	TADR_DMA2_CH2_BASE, DMA_REQUEST_3,
	TADR_DMA2_CH1_BASE, DMA_REQUEST_3 }
};
