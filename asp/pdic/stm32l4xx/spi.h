 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: spi.h 698 2016-07-31 10:36:32Z roi $
 */
/*
 * 
 *  STM32L4XX SPIデバイスドライバの外部宣言
 *
 */
 ...
 *  SPI NISS設定定義
 */
#define SPI_NSS_PULSE_DISABLE   0x00000000
